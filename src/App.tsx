...
export default function App() {
  ...
  async function onFile(file: File) {
    ...
    setBinary(hash.binary);
    setKey(binaryToKey(hash.binary).toString());
    setFileInfo(`${file.name} (${file.type || 'unknown'}, ${file.size} bytes). Raw prefix ${prefix}; SHA-256 ${hash.hex}. File remains in this browser.`);
  }
